...
export function getDifficultyDescription(difficulty: Difficulty): string {
  switch (difficulty) {
    ...
    case 'medium':
      return 'Medium problems with larger coefficients and some fractions';
    case 'hard':
      return 'Problems that would require additional effort (but not extremely difficult) at the high school level, often requiring multiple steps and algebraic manipulation.';
    default:
